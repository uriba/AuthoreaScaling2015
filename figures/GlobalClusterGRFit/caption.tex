...
Randomized data sets present a much smaller accumulated fraction of proteins that are strongly positively correlated with growth rate (hollow circles) as is further discussed in section \ref{randanalysis}
