\label{fig:threshold}
  ...
  The maximal explained variability in each data set is marked as a horizontal dashed line and is $\hMaxExpVar{}\%$ (obtained given a threshold of $0.25$) for the data set from \cite{Heinemann2015}, and $\vMaxExpVar{}\%$ (obtained given a threshold of $0.8$) in the data from \cite{Peebo_2015}.
